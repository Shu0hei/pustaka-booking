                    ...
                    <div class='row'>
                        ...
                        <div class='col-sm-9'>
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <select name="id_kategori" class="form-control form-control-user">
                                        <option value="<?= $b['id']; ?>">Pilih data buku...</option>
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="pengarang"
                                        name="pengarang" placeholder="Masukkan nama pengarang"
                                        value='<?= $b['pengarang']; ?>'>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="penerbit" name="penerbit"
                                        placeholder="Masukkan nama penerbit" value='<?= $b['penerbit']; ?>'>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="stok" name="stok"
                                        placeholder="Masukkan nominal stok" value='<?= $b['stok']; ?>'>
                                </div>
                                <div class="form-group">
                                    <?php
                                    if (isset($b['image'])) { ?>
                                        ...
                                        <picture>
                                            ...
                                            <img src="<?= base_url('assets/img/upload/') . $b['image']; ?>"
                                                class="rounded mx-auto mb-3 d-blok" alt="..." width="70">
                                        </picture>
                                    <?php } ?>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" onclick="window.history.back(-1)">Batal
                                    ubah</button>
